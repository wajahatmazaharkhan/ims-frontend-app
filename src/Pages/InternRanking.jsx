...
const InternRanking = () => {
  ...
  return (
    <>
      {getNavbar()}
      <Wrapper>
        <div className="min-h-screen ml-0 bg-gray-50 dark:bg-gradient-to-b dark:from-slate-950 dark:to-slate-900 dark:text-slate-100 transition-colors duration-300">
